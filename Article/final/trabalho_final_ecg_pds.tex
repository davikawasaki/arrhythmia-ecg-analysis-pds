...
Essas etapas apresentadas foram executadas para cada um dos 17 arquivos e para todas as arritmias, além do arquivo 100m para extração de características de um sinal saudável (N). Após a extração de todos os \textit{CSVs}, organizou-se em um só arquivo com todas as características de todos tipos de arritmias, o qual foi repassado para ser inserido no aprendizado de máquina.

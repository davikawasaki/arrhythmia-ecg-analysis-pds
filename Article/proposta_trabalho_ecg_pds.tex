...
\begin{figure}[!b]
	\centering
	\includegraphics[width=3in]{sequenciaDespolarizacacoPolarizacao}
...
Estas morfologias permitem a verificação de anormalidades no sistema de condução cardíaca, como as arritmias que pretendem ser extraídas por meio das redes neurais.

...
\begin{figure}[!b]
	\centering
	\includegraphics[width=3in]{coracaoEsquematico}
...
\begin{figure}[!b]
	\centering
	\includegraphics[width=3in]{eventosCicloCardiaco}
...
\begin{figure}[!b]
	\centering
	\includegraphics[width=3in]{trianguloEinthoven}
...
\begin{figure}[!b]
	\centering
	\includegraphics[width=3in]{eletrocardiogramaIntervalos}
	\caption{Registro de eletrocardiograma com diferentes tipos de intervalos.}
	\label{eletrocardiogramaIntervalos}
\end{figure}

Além dos formatos de onda, o ECG apresenta alguns subperíodos que são importantes para uma análise mais detalhada, como o intervalo entre a onda P e R que representa o tempo de condução do estímulo através do nódulo atrioventricular; o complexo QRS, que representa a despolarização ventricular.
